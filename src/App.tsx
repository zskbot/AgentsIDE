...
import { Bot, Check, ChevronDown, Code2, FileCode2, Folder, GitBranch, GitPullRequest, Play, Plus, Search, Send, Settings2, Sparkles, TerminalSquare, TestTube2 } from 'lucide-react'
